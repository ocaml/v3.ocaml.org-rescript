...
import * as NewsItem$Ocamlorg from "../../common/NewsItem.js";
...
function CommunityAroundWeb$LatestNews(Props) {
  ...
  return React.createElement(React.Fragment, undefined, React.createElement("h2", {
                ...
                }, "What's the Latest?"), React.createElement("div", {
                  className: "bg-graylight flex flex-col items-center lg:flex-row lg:justify-evenly"
                }, React.createElement("img", {
                      className: "inline-block h-28 w-28 lg:h-64 lg:w-64 rounded-full mb-8 lg:mb-0",
                      alt: "",
                      src: "/static/typewriter.jpeg"
                    }), React.createElement("div", undefined, React.createElement("div", {
                          className: "bg-white border border-gray-300 overflow-hidden rounded-md mb-2"
                        }, React.createElement("ul", {
                              className: "divide-y divide-gray-300"
                            }, $$Array.mapi((function (idx, item) {
                                                    ...
                                                    target: "_blank"
                                                        ...
                                                        className: "flex justify-between items-center space-x-6"
                                                                ...
                                                                xmlns: "http://www.w3.org/2000/svg"
                                                                    ...
                                                                    fill: "#ED7109"
                                                                  })), item.title), React.createElement("svg", {
                                                            className: "w-4",
                                                            height: "24",
                                                            width: "21",
                                                            fill: "none",
                                  ...
                                  }), content.news))), React.createElement("p", {
                          className: "text-xs text-right"
                        }, React.createElement("a", {
                              className: "text-orangedark hover:text-orangedark",
                              href: "/community/newsarchive"
...
function CommunityAroundWeb(Props) {
  ...
  return React.createElement(React.Fragment, undefined, React.createElement(ConstructionBanner$Ocamlorg.make, {
                  ...
                  children: null
                    ...
                    }), React.createElement(SectionContainer$Ocamlorg.NoneFilled.make, {
                      ...
                      children: null,
                      paddingY: "pt-16 pb-3 lg:pt-24 lg:pb-8",
                      paddingX: "px-4 sm:px-6 lg:px-8"
                          ...
                          className: "mt-5 text-right"
                              ...
                              href: "#"
                            }, content.blogArchiveText + " >"))), React.createElement(SectionContainer$Ocamlorg.LargeCentered.make, {
                      children: null,
                      paddingY: "pb-14"
                    }, React.createElement("h2", {
...
function getStaticProps(_ctx) {
  ...
  var contentEn_latestNewsContent = {
    news: news
  };
  ...
  var contentEn_spaces = pageContent.spaces;
  var contentEn = {
    ...
    latestNewsContent: contentEn_latestNewsContent,
