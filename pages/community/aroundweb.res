...
module LatestNews = {
  ...
  let make = (~content) =>
    <SectionContainer.LargeCentered>
      ...
      <div className="sm:flex flex-col items-center lg:flex-row lg:justify-evenly">
        <div className="mb-10 lg:mb-0 mr-10 flex-shrink-0">
          <img
            className="h-28 w-28 lg:h-64 lg:w-64 rounded-full " src="/static/typewriter.jpeg" alt=""
          />
        </div>
        <div>
