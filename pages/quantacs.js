...
function $$default(param) {
  return React.createElement(React.Fragment, undefined, React.createElement("div", {
                  className: "bg-gray-300 min-w-full"
                      ...
                      className: "text-center pt-20 mb-4 text-xs"
                    }, "WHAT\'S UP IN"), React.createElement("h1", {
                      className: "text-center text-5xl font-bold leading-snug mb-16"
                    }, "Computer Science"), React.createElement("div", undefined, React.createElement("div", {
