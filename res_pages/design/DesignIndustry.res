...
let taridesLinkText = `Tarides company`
let taridesBody =
...
let solvuuLinkText = `Solvuu company`
let solvuuBody =
      ...
      <ul>
        <li>
          <LINK href="https://facebook.com"> 
            <img alt=facebookLinkText />
          </LINK>
          <h2>{s(facebookHeader)}</h2>
          <p>{facebookBody}</p>
        </li>
        <li>
          <LINK href="https://docker.com">
            <img alt=dockerLinkText />
          </LINK>
          <h2>{s(dockerHeader)}</h2>
          <p>{dockerBody}</p>
        </li>
        <li>
          <LINK href="https://tarides.com">
            <img alt=taridesLinkText />
          </LINK>
          <h2>{s(taridesHeader)}</h2>
          <p>{taridesBody}</p>
        </li>
        <li>
          <LINK href="https://solvuu.com">
            <img alt=solvuuLinkText />
          </LINK>
          <h2>{s(solvuuHeader)}</h2>
          <p>{solvuuBody}</p>
        </li>
      </ul>
  </article>
