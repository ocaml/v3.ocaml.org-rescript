      ...
      <div className="pr-16 sm:text-center sm:px-16">
        <p className="font-medium text-white">
          ...
          <span className="block sm:ml-2 sm:inline-block">
            <a href="/play/resources/mediaarchive" className="text-white font-bold underline">
              {s(`View Playground >>`)}
            </a>
            {s(` `)}
            <a
              href="https://www.figma.com/file/36JnfpPe1Qoc8PaJq8mGMd/V1-Pages-Next-Step?node-id=430%3A25378"
