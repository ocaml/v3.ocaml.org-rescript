  ...
  let make = (
    ...
    let heading = {
      ...
      | Some(callToAction) =>
        <TitleHeading.Large
          marginTop
          marginBottom={Tailwind.MarginBottomByBreakpoint.make(#mb6, ())}
          addBottomBar
          title
          pageDescription
          callToAction
      ...
      | None =>
        ...
        | true => Some(Tailwind.MarginBottomByBreakpoint.make(#mb24, ()))
        | false => None
        }
        <TitleHeading.Large
...
module HighlightItem = {
  ...
  let make = (~children, ~title, ~pageDescription, ~highlightContent) => {
    <MainContainer.None>
      ...
      <HighlightSection
        marginBottom={Tailwind.MarginBottomByBreakpoint.make(#mb6, ())} content=highlightContent
      />
      children
    </MainContainer.None>
  }
